    ...
    public function addProduct(){
        try{
            ...
            if($_SERVER['REQUEST_METHOD'] === 'POST'){
                ...
                // Create product - use the correct method name from your Product model
                $productId = $this->productModel->create($nome, $descricao, $preco, $id_categorias, $image); // Assuming the correct method name is create
